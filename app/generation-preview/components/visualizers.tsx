    ...
    <div className="w-60 h-40 mx-auto flex items-center justify-center">
      <div className="flex gap-3">
        {[0, 1, 2].map((i) => (
          <motion.div
            key={i}
            className="w-14 h-20 rounded-lg bg-gradient-to-br from-[#C4E0DC] to-blue-500 dark:from-[#C4E0DC] dark:to-blue-700 shadow-lg"
    ...
    switch (idx) {
      ...
      case 1:
        return {
          ...
          label: 'QUIZ',
          badge:
            'bg-[#68A89D] text-[#68A89D] border-[#68A89D] dark:bg-[#C4E0DC]/20 dark:text-[#68A89D] dark:border-[#68A89D]',
        };
      case 2:
        return {
          color: 'amber',
      ...
      {[0, 1].map((i) => (
        <motion.div
          ...
          className={cn(
            ...
            theme.color === 'teal' && 'border-[#68A89D]/30',
        ...
        <AnimatePresence mode="popLayout">
          <motion.div
            ...
            className={cn(
              ...
              theme.color === 'teal' && 'border-[#68A89D] dark:border-[#68A89D]/30',
          ...
          >
            ...
            {index === 1 && (
              <div className="flex flex-col h-full justify-center space-y-2 pt-2">
                ...
                >
                  <div className="h-2 w-3/4 bg-[#C4E0DC]/20 rounded-full" />
                </motion.div>
                  ...
                  {[0, 1, 2, 3].map((i) => (
                    <motion.div
                      ...
                      className={cn(
                        ...
                        i === 1
                          ? 'bg-[#68A89D] text-white border-[#68A89D]'
...
function ActionsVisualizer() {
  ...
  const actionItems = [
    {
      ...
      label: 'Speech',
      color: 'text-[#00726D]',
      activeBg: 'bg-[#00726D]/10',
      activeBorder: 'border-[#68A89D] dark:border-[#00726D]',
    },
    {
      icon: Focus,
      label: 'Spotlight',
  ...
  return (
    <div className="size-56 relative flex items-center justify-center">
      {/* Background pulse */}
      <motion.div
        className="absolute inset-0 blur-3xl rounded-full bg-[#00726D]/10"
        animate={{ scale: [1, 1.15, 1], opacity: [0.3, 0.5, 0.3] }}
        transition={{ duration: 3.5, repeat: Infinity }}
      />
      ...
      <div className="w-44 bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 shadow-xl overflow-hidden relative">
        {/* Header */}
        <div className="px-3 py-2 border-b border-slate-100 dark:border-slate-700 flex items-center gap-2">
          <Clapperboard className="size-3 text-[#00726D]" />
          <motion.div
            initial={{ width: 0 }}
            animate={{ width: '50%' }}
            transition={{ delay: 0.2 }}
            className="h-1.5 bg-[#00726D]/10 rounded-full"
          />
        </div>
        ...
        <div className="p-2 space-y-1.5 relative">
          ...
          <motion.div
            className="absolute left-2 right-2 rounded-lg bg-[#00726D]/10[0.06] dark:bg-[#00726D]/10[0.08]"
            style={{ height: ROW_H - 6 }}
          ...
          {actionItems.map((item, i) => {
            ...
            return (
              ...
              >
                ...
                <motion.div
                  className="size-1.5 rounded-full bg-[#00726D]"
