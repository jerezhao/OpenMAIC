  ...
  return (
    <div className="min-h-[100dvh] w-full bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-950 dark:to-slate-900 flex flex-col items-center p-4 pt-16 md:p-8 md:pt-16 overflow-x-hidden">
            ...
            <div className="absolute top-full mt-2 right-0 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg overflow-hidden z-50 min-w-[120px]">
              <button
                ...
                className={cn(
                  ...
                  locale === 'zh-CN' &&
                    'bg-[#C4E0DC]/50 dark:bg-[#00726D]/20 text-[#00726D] dark:text-[#68A89D]',
                )}
              >
                简体中文
              </button>
          ...
          {needsSetup && (
            <>
              <span className="absolute -top-0.5 -right-0.5 flex h-3 w-3">
                <span className="animate-setup-ping absolute inline-flex h-full w-full rounded-full bg-[#68A89D] opacity-75" />
                <span className="relative inline-flex rounded-full h-3 w-3 bg-[#00726D]" />
              </span>
              <span className="animate-setup-float absolute top-full mt-2 right-0 whitespace-nowrap text-[11px] font-medium text-[#00726D] dark:text-[#68A89D] bg-[#C4E0DC]/50 dark:bg-[#00726D]/20 border border-[#68A89D]/40 dark:border-[#00726D]/50 px-2 py-0.5 rounded-full shadow-sm pointer-events-none">
                {t('settings.setupNeeded')}
              </span>
            </>
          )}
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div
          className="absolute top-0 left-1/4 w-96 h-96 bg-[#00726D]/10 rounded-full blur-3xl animate-pulse"
          style={{ animationDuration: '4s' }}
        />
        <div
          className="absolute bottom-0 right-1/4 w-96 h-96 bg-[#C4E0DC]/15 rounded-full blur-3xl animate-pulse"
      ...
      >
        ...
        <motion.div
          ...
          className="w-full"
        >
          <div className="w-full rounded-2xl border border-border/60 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl shadow-xl shadow-black/[0.03] dark:shadow-black/20 transition-shadow focus-within:shadow-2xl focus-within:shadow-[#00726D]/[0.06]">
      ...
      {!open && (
        ...
        >
          <div className="shrink-0 relative">
            <div className="size-8 rounded-full overflow-hidden ring-[1.5px] ring-border/30 group-hover:ring-[#00726D]/60 dark:group-hover:ring-[#68A89D]/40 transition-all duration-300">
          ...
          >
            <div className="rounded-2xl bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm ring-1 ring-black/[0.04] dark:ring-white/[0.06] shadow-[0_1px_8px_-2px_rgba(0,0,0,0.06)] dark:shadow-[0_1px_8px_-2px_rgba(0,0,0,0.3)] px-2.5 py-2">
              ...
              >
                ...
                >
                  <div className="size-8 rounded-full overflow-hidden ring-[1.5px] ring-[#00726D]/70 dark:ring-[#00726D]/40 transition-all duration-300">
                    <img src={avatar} alt="" className="size-full object-cover" />
                  </div>
                  <motion.div
                    initial={{ scale: 0 }}
                ...
                <div className="flex-1 min-w-0">
                  {editingName ? (
                    <div className="flex items-center gap-1.5" onClick={(e) => e.stopPropagation()}>
                      ...
                      <button
                        onClick={commitName}
                        className="shrink-0 size-5 rounded flex items-center justify-center text-[#00726D] hover:bg-[#C4E0DC]/30 dark:hover:bg-[#00726D]/20"
                      >
                        ...
                        {AVATAR_OPTIONS.map((url) => (
                          <button
                            ...
                            className={cn(
                              ...
                              avatar === url
                                ? 'ring-2 ring-[#00726D] dark:ring-[#68A89D] ring-offset-0'
                        ...
                        <label
                          className={cn(
                            ...
                            isCustomAvatar(avatar)
                              ? 'ring-2 ring-[#00726D] dark:ring-[#68A89D] ring-offset-0 border-[#68A89D] dark:border-[#00726D] bg-[#C4E0DC]/30 dark:bg-[#00726D]/20'
  ...
  return (
    <div className="group cursor-pointer" onClick={confirmingDelete ? undefined : onClick}>
      ...
      >
        {slide && thumbWidth > 0 ? (
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="size-12 rounded-2xl bg-gradient-to-br from-[#C4E0DC] to-[#68A89D]/30 dark:from-[#00726D]/30 dark:to-[#68A89D]/20 flex items-center justify-center">
      ...
      <div className="mt-2.5 px-1 flex items-center gap-2">
        <span className="shrink-0 inline-flex items-center rounded-full bg-[#C4E0DC]/50 dark:bg-[#00726D]/30 px-2 py-0.5 text-[11px] font-medium text-[#00726D] dark:text-[#68A89D]">
