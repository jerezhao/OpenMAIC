...
const WB_STYLE =
  'bg-[#00726D] dark:bg-[#00726D]/10 border-[#68A89D]/40 dark:border-[#68A89D]/30 text-[#00726D] dark:text-[#00726D]';
const WB_ACCENT = 'bg-[#00726D] dark:bg-[#00726D]';
  ...
  return (
    ...
    >
      ...
      {isWb && (
        ...
        >
          <PenLine className="w-[7px] h-[7px] text-white dark:text-[#00726D]" strokeWidth={2.5} />
        </span>
      )}
