      ...
      >
        ...
        {!collapsed && (
          <div
            ...
            className="absolute left-0 top-0 bottom-0 w-1.5 cursor-col-resize z-50 group hover:bg-[#C4E0DC]/20 dark:hover:bg-[#C4E0DC]/20 active:bg-[#C4E0DC]/20 dark:active:bg-[#C4E0DC]/20 transition-colors"
          >
            <div className="absolute left-0.5 top-1/2 -translate-y-1/2 w-0.5 h-8 rounded-full bg-gray-300 dark:bg-gray-600 group-hover:bg-[#68A89D] dark:group-hover:bg-[#68A89D] transition-colors" />
          </div>
        )}
