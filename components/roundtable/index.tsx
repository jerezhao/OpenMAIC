    ...
    <div className="h-[192px] w-full flex flex-col relative z-10 border-t border-gray-100 dark:border-gray-800 bg-white/60 dark:bg-gray-800/60 backdrop-blur-md">
      ...
      <div className="flex-1 flex items-stretch min-h-0">
        ...
        <div className="w-[90px] shrink-0 flex flex-col border-r border-gray-100/50 dark:border-gray-700/50 bg-white/40 dark:bg-gray-900/40 overflow-visible relative">
          ...
          <div className="absolute top-0 inset-x-0 h-16 bg-gradient-to-b from-[#C4E0DC]/30 dark:from-[#C4E0DC]/30 to-transparent pointer-events-none" />
          <div className="absolute top-3 inset-x-0 flex flex-col items-center justify-center gap-1 opacity-10 pointer-events-none">
            <BookOpen size={20} className="text-[#68A89D] dark:text-[#68A89D]" />
            <div className="w-8 h-0.5 bg-[#68A89D] dark:bg-[#68A89D] rounded-full" />
          </div>
                    ...
                    >
                      <div
                        className={cn(
                          ...
                          activeRole === 'teacher'
                            ? 'border-[#68A89D] dark:border-[#68A89D] shadow-[0_0_12px_rgba(168,85,247,0.4)]'
                            : 'border-gray-200 dark:border-gray-700 group-hover:border-[#68A89D] dark:group-hover:border-[#68A89D]',
                        )}
                      />
                    ...
                    <span
                      className={cn(
                        ...
                        activeRole === 'teacher' && !speakingStudent
                          ? 'text-[#68A89D] dark:text-[#68A89D] border-[#68A89D] dark:border-[#68A89D]'
                          : 'text-gray-400 dark:text-gray-500 border-gray-100 dark:border-gray-700 group-hover:text-[#68A89D] dark:group-hover:text-[#68A89D] group-hover:border-[#68A89D] dark:group-hover:border-[#68A89D]',
                      )}
                    >
                      {teacherName}
                    </span>
          ...
          >
            ...
            <AnimatePresence>
              {isInputOpen && (
                ...
                >
                  <div className="relative w-fit max-w-[85%] sm:max-w-[65%] min-w-[200px] sm:min-w-[300px] bg-white/90 dark:bg-gray-800/90 backdrop-blur-md p-2 pr-2 rounded-2xl rounded-br-none shadow-2xl border border-[#68A89D] dark:border-[#68A89D] flex items-end gap-2 ring-1 ring-[#68A89D]/30 dark:ring-[#68A89D]/30">
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        isSendCooldown
                          ...
                          : 'bg-[#68A89D] hover:bg-[#68A89D] dark:bg-[#68A89D] dark:hover:bg-[#68A89D] shadow-[#00726D] dark:shadow-[#00726D]/30',
                      )}
                    >
                      {isSendCooldown ? (
              ...
              {isVoiceOpen && (
                ...
                >
                  <div className="flex flex-col-reverse items-end gap-1 mr-[-10px] relative z-20">
                    <div className="flex items-center gap-0.5 h-8 px-2 py-1.5 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md rounded-xl border border-[#68A89D] dark:border-[#68A89D] shadow-sm">
                      {[...Array(12)].map((_, i) => (
                        <motion.div
                          key={i}
                          animate={{
                          ...
                          className="w-1 bg-gradient-to-t from-[#C4E0DC] to-indigo-600 dark:from-[#C4E0DC] dark:to-indigo-500 rounded-full"
                        />
                      ))}
                    </div>
                    <motion.div
                      ...
                      className="text-[10px] font-bold tracking-widest text-[#68A89D] dark:text-[#68A89D] uppercase bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm px-2 py-0.5 rounded-full shadow-sm border border-[#68A89D]/30 dark:border-[#68A89D]/30 mr-1"
                    >
                  ...
                  >
                    <div className="relative w-16 h-16 rounded-full bg-gradient-to-br from-[#C4E0DC] to-indigo-700 dark:from-[#C4E0DC] dark:to-indigo-600 shadow-[0_4px_20px_rgba(147,51,234,0.3)] flex items-center justify-center z-20 group-hover:scale-105 transition-transform duration-300 border border-white/20 dark:border-white/10">
                      <Mic className="w-6 h-6 text-white" />
                    </div>
                    <div className="absolute inset-0 rounded-full border-2 border-[#68A89D] dark:border-[#68A89D] opacity-40 animate-[ping_2s_ease-in-out_infinite] z-10" />
                    ...
                    <div className="absolute inset-0 bg-[#68A89D] dark:bg-[#68A89D] blur-2xl opacity-20 group-hover:opacity-40 transition-opacity z-0" />
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
                ...
                >
                  <div className="flex gap-1">
                    <motion.div
                      ...
                      className="w-1.5 h-1.5 rounded-full bg-[#68A89D]"
                    />
                    <motion.div
                      animate={{ opacity: [0.3, 1, 0.3] }}
                      transition={{
                    ...
                    <div
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'bg-[#C4E0DC]/20[0.08] dark:bg-[#C4E0DC]/20[0.06]',
                      )}
                    />
                    ...
                    <motion.div
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'border-[#68A89D]/30 dark:border-[#68A89D]/30',
                      )}
                    />
                    {/* Expanding ripple 2 */}
                    <motion.div
                    ...
                    <motion.button
                      ...
                      className={cn(
                        ...
                        asrEnabled
                          ...
                          : 'from-[#C4E0DC] to-indigo-500 dark:from-[#C4E0DC] dark:to-indigo-600 shadow-[#00726D]/30 dark:shadow-[#00726D]/30 hover:shadow-[#00726D]/30 dark:hover:shadow-[#00726D]/30',
                      )}
                    >
                      {asrEnabled ? (
                    ...
                    <div className="flex items-center justify-center gap-[3px] h-3">
                      {[0, 1, 2, 3, 2, 1, 0].map((intensity, i) => (
                        <motion.div
                          ...
                          className="w-[2.5px] h-full origin-center rounded-full bg-[#C4E0DC]/20 dark:bg-[#C4E0DC]/20"
                        />
                      ))}
                    </div>
                  )}
                  ...
                  <motion.span
                    ...
                    className={cn(
                      ...
                      asrEnabled
                        ...
                        : 'text-[#68A89D]/80 dark:text-[#68A89D]/80',
                    )}
                  >
                  ...
                  >
                    <div
                      ...
                      className={cn(
                        ...
                        bubbleRole === 'user'
                          ? 'bg-[#C4E0DC]/20 dark:bg-[#C4E0DC]/20 backdrop-blur-sm border-[#68A89D]/30 dark:border-[#68A89D]/30 text-white rounded-br-sm shadow-md shadow-[#00726D]/30 dark:shadow-[#00726D]/30'
                          : bubbleRole === 'agent'
                            ? cn(
                    ...
                    >
                            ...
                            >
                              <div
                                className={cn(
                                  ...
                                  bubbleRole === 'user'
                                    ? 'border-[#68A89D] dark:border-[#68A89D]'
                                    : bubbleRole === 'agent'
                      ...
                      {bubbleRole !== 'user' &&
                        ...
                        (() => {
                          ...
                          const barsColor =
                            bubbleRole === 'agent' ? 'bg-blue-500' : 'bg-[#68A89D]';

                          if (btnState === 'none') return null;

                          if (btnState === 'play') {
                            return (
                              <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 hover:bg-[#68A89D] dark:hover:bg-[#C4E0DC]/20 group-hover/bubble:bg-[#68A89D] dark:group-hover/bubble:bg-[#C4E0DC]/20 transition-all duration-300 cursor-pointer">
                                <Play className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 hover:text-[#68A89D] dark:hover:text-[#68A89D] group-hover/bubble:text-[#68A89D] dark:group-hover/bubble:text-[#68A89D] ml-0.5" />
                              </div>
                            );
                          }
                          ...
                          if (btnState === 'restart') {
                            return (
                              <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 hover:bg-[#68A89D] dark:hover:bg-[#C4E0DC]/20 group-hover/bubble:bg-[#68A89D] dark:group-hover/bubble:bg-[#C4E0DC]/20 transition-all duration-300 cursor-pointer">
                                <Repeat className="w-3.5 h-3.5 text-gray-400 dark:text-gray-500 hover:text-[#68A89D] dark:hover:text-[#68A89D] group-hover/bubble:text-[#68A89D] dark:group-hover/bubble:text-[#68A89D]" />
                              </div>
                            );
                          }
                          ...
                          // btnState === 'bars'
                          return (
                            <div className="absolute right-2.5 bottom-2.5 p-1.5 rounded-full bg-gray-50/80 dark:bg-gray-700/80 group-hover/bubble:bg-[#68A89D] dark:group-hover/bubble:bg-[#C4E0DC]/20 transition-all duration-300">
                              ...
                              {/* Pause icon on hover */}
                              <Pause className="w-3.5 h-3.5 text-[#68A89D] dark:text-[#68A89D] hidden group-hover/bubble:block" />
                            </div>
                          );
                        })()}
                    </div>
                          ...
                          >
                            <div
                              className={cn(
                                ...
                                isSpeaking
                                  ? 'border-[#68A89D] dark:border-[#68A89D] shadow-[0_0_8px_rgba(168,85,247,0.4)]'
                            ...
                            {isThinkingAgent && (
                              <div className="absolute inset-0 rounded-full border-2 border-[#68A89D] border-t-transparent animate-spin z-20" />
                            )}
                          </div>
                        </HoverCardTrigger>
                        <HoverCardContent
                  ...
                  <div className="flex items-center gap-[3px]">
                    {[0, 1, 2].map((i) => (
                      <motion.div
                        ...
                        className="w-[4px] h-[4px] rounded-full bg-[#68A89D] dark:bg-[#68A89D]"
                      />
                    ))}
                  </div>
                </div>
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      !asrEnabled
                        ...
                        : isVoiceOpen
                          ? 'bg-[#68A89D] dark:bg-[#68A89D] border-[#68A89D] dark:border-[#68A89D] text-white shadow-[#00726D] dark:shadow-[#00726D]'
                          : 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 text-gray-400 dark:text-gray-500 hover:bg-[#68A89D] dark:hover:bg-[#C4E0DC]/20 hover:text-[#68A89D] dark:hover:text-[#68A89D] hover:border-[#68A89D] dark:hover:border-[#68A89D]',
                    )}
                  >
                    {asrEnabled ? (
                  ...
                  className={cn(
                    ...
                    isCueUser
                      ...
                      : activeRole === 'user' || isInputOpen
                        ? 'border-[#68A89D] dark:border-[#68A89D] shadow-[0_0_8px_rgba(168,85,247,0.3)]'
                        : 'border-white dark:border-gray-700 group-hover:border-[#68A89D] dark:group-hover:border-[#68A89D]',
                  )}
                />
