    ...
    >
      ...
      {!collapsed && (
        <div
          ...
          className="absolute right-0 top-0 bottom-0 w-1.5 cursor-col-resize z-50 group hover:bg-[#C4E0DC]/20 dark:hover:bg-[#C4E0DC]/20 active:bg-[#C4E0DC]/20 dark:active:bg-[#C4E0DC]/20 transition-colors"
        >
          <div className="absolute right-0.5 top-1/2 -translate-y-1/2 w-0.5 h-8 rounded-full bg-gray-300 dark:bg-gray-600 group-hover:bg-[#68A89D] dark:group-hover:bg-[#68A89D] transition-colors" />
        </div>
      )}
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isActive
                    ? 'bg-[#68A89D] dark:bg-[#C4E0DC]/20 ring-1 ring-[#68A89D] dark:ring-[#68A89D]'
                  ...
                  <div className="flex items-center gap-2 max-w-full">
                    <span
                      className={cn(
                        ...
                        isActive
                          ? 'bg-[#68A89D] dark:bg-[#68A89D] text-white shadow-sm shadow-[#00726D]/30'
                ...
                <div className="relative aspect-video w-full rounded overflow-hidden bg-gray-100 dark:bg-gray-800 ring-1 ring-black/5 dark:ring-white/5">
                  <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    {isSlide && (
                      <div
                        className={cn(
                          'absolute inset-0 bg-[#C4E0DC]/20 transition-colors',
                          isActive
                            ? 'bg-[#C4E0DC]/20'
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isActive &&
                      !isFailed &&
                      'bg-[#68A89D] dark:bg-[#C4E0DC]/20 ring-1 ring-[#68A89D] dark:ring-[#68A89D] opacity-100',
                  )}
                >
                  {/* Scene Header */}
                  <div className="flex justify-between items-center px-2 pt-0.5">
