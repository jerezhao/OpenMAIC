    ...
    >
      ...
      >
        {showDisabled ? (
          ...
          <div className="w-full h-full bg-gradient-to-br from-indigo-50 via-[#68A89D]/20 to-blue-50 dark:from-indigo-950/40 dark:via-[#68A89D]/20 dark:to-blue-950/20 flex items-center justify-center rounded">
            <style>{`
