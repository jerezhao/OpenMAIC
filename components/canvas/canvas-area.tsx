                ...
                {isGenerationFailed ? (
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="relative w-12 h-12">
                      ...
                      <div className="absolute inset-0 rounded-full border-2 border-transparent border-t-[#00726D] dark:border-t-[#00726D] animate-spin" />
                    </div>
                    {/* Text */}
                    <motion.span
            ...
            {showPlayHint && (
              ...
              >
                ...
                >
                  ...
                  >
                    <Play className="w-7 h-7 text-[#68A89D] dark:text-[#68A89D] fill-[#00726D]/90 dark:fill-[#00726D]/90 ml-0.5" />
                  </motion.div>
                </motion.div>
              </motion.div>
            )}
