      ...
      <PopoverTrigger asChild>
        <button
          className={cn(
            ...
            enabledCount > 0
              ? 'bg-[#00726D] dark:bg-[#00726D]/10 text-[#00726D] dark:text-[#00726D] border-[#68A89D]/60 dark:border-[#68A89D]/50'
            ...
            {TABS.map((tab) => {
              ...
              return (
                ...
                >
                  ...
                  {isEnabled && !isActive && (
                    <span className="absolute top-1 right-1 size-1.5 rounded-full bg-[#00726D]" />
                  )}
                </button>
              );
            })}
      ...
      <div className="flex items-center gap-2.5">
        <Icon
          className={cn(
            ...
            enabled ? 'text-[#00726D] dark:text-[#00726D]' : 'text-muted-foreground/50',
          )}
        />
        <span
          className={cn(
