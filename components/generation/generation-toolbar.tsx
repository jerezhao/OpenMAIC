...
export function GenerationToolbar({
  ...
  const pillActive = `${pillCls} border-[#68A89D]/60 dark:border-[#68A89D]/50 bg-[#00726D] dark:bg-[#00726D]/10 text-[#00726D] dark:text-[#00726D]`;
        ...
        <PopoverTrigger asChild>
          {pdfFile ? (
            <button className={pillActive}>
              ...
              <span
                role="button"
                className="size-4 rounded-full inline-flex items-center justify-center hover:bg-[#00726D] dark:hover:bg-[#00726D] transition-colors"
                onClick={(e) => {
                  e.stopPropagation();
            ...
            {pdfFile ? (
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <div className="size-8 rounded-lg bg-[#00726D] dark:bg-[#00726D]/10 flex items-center justify-center shrink-0">
                    <FileText className="size-4 text-[#00726D] dark:text-[#00726D]" />
                  </div>
              ...
              <div
                className={cn(
                  ...
                  isDragging
                    ? 'border-[#68A89D] bg-[#00726D] dark:bg-[#00726D]/10'
                    : 'border-muted-foreground/20 hover:border-[#68A89D]',
                )}
          ...
          <PopoverContent align="start" className="w-64 p-3 space-y-3">
            ...
            <button
              ...
              className={cn(
                ...
                webSearch
                  ? 'bg-[#00726D] dark:bg-[#00726D]/10 border-[#68A89D] dark:border-[#00726D]'
            ...
            >
              <Globe2
                className={cn(
                  'size-4 shrink-0',
                  webSearch ? 'text-[#00726D] dark:text-[#00726D]' : 'text-muted-foreground',
                )}
              />
          ...
          <PopoverTrigger asChild>
            <button
              className={cn(
                ...
                currentModelId &&
                  'ring-[#68A89D] dark:ring-[#00726D] bg-[#00726D] dark:bg-[#00726D]/10',
              )}
            >
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    isActive ? 'bg-[#00726D]/10 dark:bg-[#00726D]/10' : 'hover:bg-muted/50',
                  )}
                >
                  {provider.icon ? (
                    <img
            ...
            {activeProvider.models.map((model) => {
              ...
              return (
                ...
                >
                  ...
                  {isSelected && (
                    <Check className="size-3.5 shrink-0 text-[#00726D] dark:text-[#00726D]" />
                  )}
                </button>
              );
            })}
