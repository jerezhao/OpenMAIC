    ...
    <div className="flex items-center gap-1.5 shrink-0">
      ...
      {agentMode === 'auto' ? (
        <>
          ...
          <Shuffle className="size-4 text-[#00726D] dark:text-[#00726D]" />
        </>
      ) : (
        <>
              ...
              {agentMode === 'preset' ? (
                ...
                <div className="flex flex-col items-center pt-6 pb-2 gap-8">
                  ...
                  <div className="relative flex items-center justify-center">
                    {/* Ping ripple */}
                    <div className="absolute size-12 rounded-full bg-[#00726D]/10 dark:bg-[#00726D]/10 animate-ping [animation-duration:3s]" />
                    {/* Soft glow ring */}
                    <div className="absolute size-14 rounded-full bg-[#00726D]/10 dark:bg-[#00726D]/10 animate-pulse [animation-duration:2.5s]" />
                    {/* Icon */}
                    <Shuffle className="relative size-7 text-[#00726D] dark:text-[#00726D]" />
                  </div>
