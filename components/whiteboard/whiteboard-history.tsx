                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        ...
                        disabled={isClearing}
                        className="ml-2 px-2 py-1 text-xs text-[#68A89D] dark:text-[#68A89D] hover:bg-[#68A89D] dark:hover:bg-[#C4E0DC]/20 rounded-md opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1 disabled:opacity-40 disabled:cursor-not-allowed disabled:hover:bg-transparent"
                      >
