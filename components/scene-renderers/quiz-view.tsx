  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center gap-4 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 p-6 opacity-[0.03]">
        <PieChart className="w-52 h-52 text-[#00726D]" />
      </div>
      <div className="absolute bottom-0 left-0 p-6 opacity-[0.02]">
        <BookOpenText className="w-40 h-40 text-[#00726D] rotate-12" />
      </div>
      ...
      <motion.div
        ...
        className="w-16 h-16 bg-gradient-to-br from-[#C4E0DC] to-[#68A89D] dark:from-[#C4E0DC]/30 dark:to-[#68A89D]/20 rounded-2xl flex items-center justify-center shadow-lg shadow-[#00726D] dark:shadow-[#00726D]/20 ring-1 ring-[#68A89D]/50 dark:ring-[#68A89D]/50"
      >
        <PieChart className="w-8 h-8 text-[#00726D]" />
      </motion.div>
      ...
      >
        <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
          <div className="w-7 h-7 rounded-lg bg-[#00726D] dark:bg-[#00726D]/10 flex items-center justify-center">
            <BookOpenText className="w-3.5 h-3.5 text-[#00726D]" />
          </div>
          <span>
        ...
        <div className="flex items-center gap-2 text-gray-500 dark:text-gray-400">
          <div className="w-7 h-7 rounded-lg bg-[#00726D] dark:bg-[#00726D]/10 flex items-center justify-center">
            <PieChart className="w-3.5 h-3.5 text-[#00726D]" />
          </div>
          <span>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        onClick={onStart}
        className="mt-1 px-8 py-2.5 bg-gradient-to-r from-[#C4E0DC] to-[#68A89D] text-white rounded-full font-medium shadow-lg shadow-[#00726D]/20 dark:shadow-[#00726D]/20 hover:shadow-[#00726D]/20 transition-shadow z-10 flex items-center gap-2"
      >
        {t('quiz.startQuiz')}
          ...
          return (
            <button
              ...
              className={cn(
                ...
                !isReview &&
                  !selected &&
                  'border-gray-200 dark:border-gray-600 hover:border-[#68A89D] dark:hover:border-[#68A89D] hover:bg-[#00726D]/10 dark:hover:bg-[#00726D]/10',
                !isReview &&
                  selected &&
                  'border-[#68A89D] bg-[#00726D] dark:bg-[#00726D]/10 ring-1 ring-[#68A89D] dark:ring-[#00726D]',
                // Review states
                isReview &&
                  isCorrectOpt &&
            ...
            >
              <span
                className={cn(
                  ...
                  !isReview && selected && 'bg-[#00726D] text-white',
              ...
              <span
                className={cn(
                  ...
                  !isReview &&
                    !isSelected &&
                    'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400',
                  !isReview && isSelected && 'bg-[#00726D] text-white',
                  isReview && isCorrectOpt && 'bg-emerald-500 text-white',
      ...
      {!isReview ? (
        <div className="relative">
          <textarea
            ...
            className="w-full min-h-[100px] p-3 pb-10 rounded-xl border border-gray-200 dark:border-gray-600 text-sm resize-none focus:outline-none focus:border-[#68A89D] dark:focus:border-[#68A89D] focus:ring-2 focus:ring-[#68A89D] dark:focus:ring-[#68A89D]/50 transition-all disabled:bg-gray-50 dark:disabled:bg-gray-800 disabled:text-gray-500 dark:bg-gray-800/50 dark:text-gray-200 dark:placeholder:text-gray-500"
          />
          <SpeechButton
            size="sm"
            disabled={disabled}
        ...
        <div className="space-y-3">
          ...
          {result.aiComment && (
            <div className="flex items-start gap-2 px-3 py-2 rounded-lg bg-[#00726D] dark:bg-[#00726D]/10 border border-[#68A89D] dark:border-[#00726D]">
              <Sparkles className="w-4 h-4 text-[#00726D] shrink-0 mt-0.5" />
              <div>
                <p className="text-xs font-medium text-[#00726D] dark:text-[#00726D] mb-0.5">
                  {t('quiz.aiComment')}
                </p>
                <p className="text-xs text-[#00726D]/80 dark:text-[#00726D]/80">
                  {result.aiComment}
                </p>
              </div>
              <span className="ml-auto text-xs font-bold text-[#00726D] dark:text-[#00726D] shrink-0">
        ...
        <div className="flex items-start gap-3">
          <span
            className={cn(
              ...
              !isReview &&
                'bg-[#00726D] dark:bg-[#00726D]/10 text-[#00726D] dark:text-[#00726D]',
              isReview &&
                result.status === 'correct' &&
      ...
      <AnimatePresence mode="wait">
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-gray-100 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur shrink-0">
              <div className="flex items-center gap-2">
                <PieChart className="w-4 h-4 text-[#00726D]" />
              ...
              <button
                ...
                className={cn(
                  ...
                  allAnswered
                    ? 'bg-gradient-to-r from-[#C4E0DC] to-[#68A89D] text-white shadow-sm hover:shadow-md hover:shadow-[#00726D]/20 dark:hover:shadow-[#00726D]/20 active:scale-[0.97]'
        ...
        {phase === 'grading' && (
          ...
          >
            ...
            >
              <Loader2 className="w-10 h-10 text-[#00726D]" />
            </motion.div>
            ...
            <div className="flex gap-1 mt-2">
              {[0, 1, 2].map((i) => (
                <motion.div
                  key={i}
                  className="w-2 h-2 rounded-full bg-[#00726D]"
        ...
        {phase === 'reviewing' && (
          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-3 border-b border-gray-100 dark:border-gray-700 bg-white/80 dark:bg-gray-900/80 backdrop-blur shrink-0">
              ...
              <button
                onClick={handleRetry}
                className="flex items-center gap-1.5 text-xs text-gray-500 dark:text-gray-400 hover:text-[#00726D] dark:hover:text-[#00726D] transition-colors"
              >
