      ...
      <TooltipTrigger asChild>
        <button
          ...
          className={cn(
            ...
            sizeClasses,
            active
              ? 'bg-[#00726D]/10 dark:bg-[#00726D]/10 text-white shadow-[0_0_12px_rgba(139,92,246,0.45)] dark:shadow-[0_0_12px_rgba(139,92,246,0.3)]'
        ...
        >
          ...
          {isRecording && (
            <span
              className="absolute inset-[-4px] rounded-[10px] border border-[#68A89D]/40 dark:border-[#68A89D]/25"
              style={{
