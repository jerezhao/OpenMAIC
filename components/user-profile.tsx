  ...
  return (
    <Card className="p-5 !gap-0 shadow-xl border-muted/40 backdrop-blur-xl bg-white/80 dark:bg-slate-900/80">
      ...
      <div className="flex items-center gap-3.5">
        ...
        >
          <div className="size-11 rounded-full bg-gray-50 dark:bg-gray-800 overflow-hidden ring-2 ring-[#68A89D]/50 dark:ring-[#68A89D]/50 group-hover/avatar:ring-[#68A89D] dark:group-hover/avatar:ring-[#68A89D] transition-all">
          ...
          {editingName ? (
            <div className="flex items-center gap-1.5">
              <input
                ...
                className="flex-1 min-w-0 h-7 bg-transparent border-b-2 border-[#68A89D] dark:border-[#00726D] text-sm font-semibold text-foreground outline-none placeholder:text-muted-foreground/40"
              />
              <button
                onClick={commitName}
                className="shrink-0 size-6 rounded-md flex items-center justify-center text-[#00726D] hover:bg-[#00726D] dark:hover:bg-[#00726D]/10 transition-colors"
              >
              ...
              {AVATAR_OPTIONS.map((url) => (
                <button
                  ...
                  className={cn(
                    ...
                    avatar === url
                      ? 'ring-2 ring-[#68A89D] dark:ring-[#00726D] ring-offset-1 ring-offset-white dark:ring-offset-slate-900'
              ...
              <label
                ...
                className={cn(
                  ...
                  isCustomAvatar(avatar)
                    ? 'ring-2 ring-[#68A89D] dark:ring-[#00726D] ring-offset-1 ring-offset-white dark:ring-offset-slate-900 border-[#68A89D] dark:border-[#00726D] bg-[#00726D] dark:bg-[#00726D]/10'
